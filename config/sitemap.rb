...
SitemapGenerator::Sitemap.create do
  ...
  add new_user_session_path, changefreq: 'weekly', priority: 0.4
  add new_user_registration_path, changefreq: 'weekly', priority: 0.4

  # Add all item pages
  Item.find_each do |item|
    add item_path(item_slug: item.url_slug), priority: 0.8, lastmod: item.updated_at
  end
end
